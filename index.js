...
sourceUrl: "https://chat.whatsapp.com/KmRqBewi4be7LGql2OF9vq",
mediaType: 1,
...
mediaType: 1,
thumbnailUrl: ppuser,
sourceUrl: "https://instagram.com/rzldsta_",
renderLargerThumbnail: true
}
}
...
ehz.sendTextWithMentions = async (jid, text, quoted, options = {}) => ehz.sendMessage(jid, { text: text, contextInfo: { mentionedJid: [...text.matchAll(/@(\d{0,16})/g)].map(v => v[1] + '@s.whatsapp.net') }, ...options }, { quoted })
 //=================================================//
  ...
  title:"Bot°᭄ᴮᵒᵗ",body: `${textT}`,previewType:"PHOTO",thumbnail: fs.readFileSync('./media/thumb.jpeg'),
  sourceUrl:'https://chat.whatsapp.com/KmRqBewi4be7LGql2OF9vq'																																
...
connectToWhatsApp();
  ...
  ehz.sendMessage('6285730672259' + "@s.whatsapp.net", { text: `Hai Sayang Aku On Kembali 
